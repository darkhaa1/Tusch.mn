...
import { Badge, Button, Card, CardContent, Input, Select, SelectLabel } from "@repo/ui";
import { useAdminListings, useUpdateAdminListingStatus } from "../../hooks/useApi";
import type { AdminListing, ListingStatus } from "../../lib/api/types";
      ...
      {error ? (
        <Card className="border border-border/80">
          <CardContent className="p-6 text-sm text-destructive">
            Заруудын жагсаалт ачааллахад алдаа гарлаа.
          </CardContent>
        </Card>
      ) : null}
          ...
          <table className="min-w-[860px] w-full text-sm">
            <thead className="bg-muted/40 text-muted-foreground">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium">Эзэмшигч</th>
